...
BOOST_AUTO_TEST_CASE(PgTablesGetMusicByAlbumTest)
{
	...
	BOOST_TEST(res[0].name == "vgm322");
	BOOST_TEST(res[1].name == "vgm323");
	BOOST_TEST(res[2].name == "vgm321");
}
...
BOOST_AUTO_TEST_CASE(PgTablesGetMusicByArtistTest)
{
	...
	BOOST_TEST(res[0].name == "vgm322");
	BOOST_TEST(res[1].name == "vgm323");
	BOOST_TEST(res[2].name == "vgm411");

	BOOST_TEST(res[3].name == "vgm413");
	BOOST_TEST(res[4].name == "vgm321");
	BOOST_TEST(res[5].name == "vgm412");
